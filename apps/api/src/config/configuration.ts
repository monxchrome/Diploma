...
export default function configuration() {
  ...
  return {
    ...
    benchmark: {
      adminOnly: env.BENCHMARK_ADMIN_ONLY,
      artifactRetentionDays: env.BENCHMARK_ARTIFACT_RETENTION_DAYS,
      caseTimeoutMs: env.BENCHMARK_CASE_TIMEOUT_SECONDS * 1_000,
      defaultCurrency: env.BENCHMARK_DEFAULT_CURRENCY,
      defaultMaxOutputTokens: env.BENCHMARK_DEFAULT_MAX_OUTPUT_TOKENS,
      defaultRandomSeed: env.BENCHMARK_DEFAULT_RANDOM_SEED,
      defaultTemperature: env.BENCHMARK_DEFAULT_TEMPERATURE,
      defaultTopP: env.BENCHMARK_DEFAULT_TOP_P,
      enabled: env.BENCHMARK_ENABLED,
      equalTotalTokenBudget: env.BENCHMARK_EQUAL_TOTAL_TOKEN_BUDGET,
      humanEvaluationEnabled: env.BENCHMARK_HUMAN_EVALUATION_ENABLED,
      llmJudgeEnabled: env.BENCHMARK_LLM_JUDGE_ENABLED,
      maxCaseRuns: env.BENCHMARK_MAX_CASE_RUNS,
      maxConcurrency: env.BENCHMARK_MAX_CONCURRENCY,
      maxEstimatedCostMinor: env.BENCHMARK_MAX_ESTIMATED_COST_MINOR,
      maxRepetitions: env.BENCHMARK_MAX_REPETITIONS,
      maxVariants: env.BENCHMARK_MAX_VARIANTS,
      providerConcurrency: {
        anthropic: env.BENCHMARK_ANTHROPIC_MAX_CONCURRENCY,
        ollama: env.BENCHMARK_OLLAMA_MAX_CONCURRENCY,
        openai: env.BENCHMARK_OPENAI_MAX_CONCURRENCY,
      },
      providerRetryAttempts: env.BENCHMARK_PROVIDER_RETRY_ATTEMPTS,
      providerRetryDelayMs: env.BENCHMARK_PROVIDER_RETRY_DELAY_MS,
      providerTimeoutSeconds: env.BENCHMARK_PROVIDER_CALL_TIMEOUT_SECONDS,
      reproducibilityBucket: env.BENCHMARK_REPRODUCIBILITY_BUCKET,
    },
    aiService: {
