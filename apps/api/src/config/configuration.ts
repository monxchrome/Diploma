...
export default function configuration() {
  ...
  return {
    ...
    reports: {
      branding: {
        enabled: env.REPORT_BRANDING_ENABLED,
        logoMaxBytes: env.REPORT_BRANDING_LOGO_MAX_BYTES,
        logoMaxHeight: env.REPORT_BRANDING_LOGO_MAX_HEIGHT,
        logoMaxWidth: env.REPORT_BRANDING_LOGO_MAX_WIDTH,
        safeSvgEnabled: env.REPORT_BRANDING_SAFE_SVG_ENABLED,
      },
      comments: {
        enabled: env.REPORT_COMMENTS_ENABLED,
        maxLength: env.REPORT_COMMENT_MAX_LENGTH,
        maxMentions: env.REPORT_COMMENT_MAX_MENTIONS,
        rateLimit: env.REPORT_COMMENT_RATE_LIMIT,
      },
      export: {
        bucket: env.REPORT_EXPORT_BUCKET,
        docxEnabled: env.REPORT_EXPORT_DOCX_ENABLED,
        enabled: env.REPORT_EXPORT_ENABLED,
        markdownEnabled: env.REPORT_EXPORT_MARKDOWN_ENABLED,
        maxArtifactBytes: env.REPORT_EXPORT_MAX_ARTIFACT_BYTES,
        maxInputBytes: env.REPORT_EXPORT_MAX_INPUT_BYTES,
        maxConcurrency: env.REPORT_EXPORT_MAX_CONCURRENCY,
        pdfEnabled: env.REPORT_EXPORT_PDF_ENABLED,
        queueName: env.REPORT_EXPORT_QUEUE_NAME,
        remoteAssetsEnabled: env.REPORT_EXPORT_REMOTE_ASSETS_ENABLED,
        retentionDays: env.REPORT_EXPORT_RETENTION_DAYS,
        signedUrlTtlSeconds: env.REPORT_EXPORT_SIGNED_URL_TTL_SECONDS,
        templateVersion: env.REPORT_EXPORT_TEMPLATE_VERSION,
        timeoutSeconds: env.REPORT_EXPORT_TIMEOUT_SECONDS,
      },
      notifications: {
        enabled: env.COLLABORATION_NOTIFICATIONS_ENABLED,
        realtimeEnabled: env.COLLABORATION_REALTIME_ENABLED,
      },
      share: {
        defaultExpiryDays: env.REPORT_SHARE_DEFAULT_EXPIRY_DAYS,
        enabled: env.REPORT_SHARE_ENABLED,
        maxExpiryDays: env.REPORT_SHARE_MAX_EXPIRY_DAYS,
        noExpiryEnabled: env.REPORT_SHARE_NO_EXPIRY_ENABLED,
        publicEnabled: env.REPORT_SHARE_PUBLIC_ENABLED,
        tokenBytes: env.REPORT_SHARE_TOKEN_BYTES,
        viewCountEnabled: env.REPORT_SHARE_VIEW_COUNT_ENABLED,
      },
      snapshot: {
        enabled: env.REPORT_SNAPSHOT_ENABLED,
        schemaVersion: env.REPORT_SNAPSHOT_SCHEMA_VERSION,
      },
    },
    redis: {
      url: env.REDIS_URL,
